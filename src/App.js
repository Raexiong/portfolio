...
import Photo from "./images/Ruijia.jpg";
import {
  VerticalTimeline,
      ...
      <div className="flex w-screen min-h-screen flex-col items-center justify-center relative bg-primary pb-20">
        <nav className="w-full px-6 z-50  fixed inset-x-0 top-2 flex justify-center items-center ">
          <div className=" w-full md:w-880 bg-navBar p-4 rounded-2xl flex items-center">
            <p className="text-lg text-slate-200 font-medium">Ruijia Xiong</p>
          ...
          >
            ...
            <div className="w-full h-420 flex flex-col items-center justify-center ">
              <p className="text-lg text-textBase text-start">
                ...
                Python, Java, C, C++, JavaScript, R, Kotlin
                <br />
                <IoLogoReact className="inline font-medium animate-bounce text-red-200 mx-2" />
                Node.js, Express, Spring Boot, Django, Flask, React, Vue,
                TensorFlow
                <br />
                <IoGlobeSharp className="inline font-medium animate-bounce text-blue-200 mx-2" />
                Maven, Git, Vim, Linux, Ubuntu, JUnit, MySQL, PostGreSQL,
                MongoDB, Axios, AWS
                <br />
              </p>
